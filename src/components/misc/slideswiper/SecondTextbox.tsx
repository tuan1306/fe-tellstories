...
interface SecondTextBoxProps extends PanelSwiperProps {
  currentPanelIndex: number;
  setPanelContents: React.Dispatch<React.SetStateAction<string[]>>;
}

export default function SecondTextBoxProps({
  panels,
  panelContents,
  setPanelContents,
  currentPanelIndex,
    ...
    <div className="space-y-4 w-full max-w-2xl mx-auto p-4 rounded-xl shadow-sm">
      {panel.imageUrl && (
        <div className="w-full h-60 relative rounded-md overflow-hidden shadow-md">
          <Image
            src="https://images.pexels.com/photos/33243200/pexels-photo-33243200.jpeg"
      ...
      >
        <div className="relative w-[100%] h-[27vh]">
          {isImproving && (
